...
if(selected==="Indonesia"){
    var data = "id"
     ...
     $.ajax({
          method: 'GET',
         url: 'https://newsapi.org/v2/top-headlines?apiKey=aca8cb525fe442179faf23789449d4c1&country=' + data, 
        }).then(function(res){
            ...
            fetch.forEach(function(element) {
               ...
               var  dataimage
               console.log(element)
               dataitems = `<li> <img  src="${element.urlToImage}" alt="" style="height:400px"><h5>${element.title}</h5>
